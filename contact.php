...
if (isset($_POST['submit'])) {
    ...
    if (!(empty($name) && empty($email) && empty($subject) && empty($message))) {
        ...
        $email_to = "contact@schuleinstitute.com";
...
<head>
    ...
    <title>Schule Institute - Contact</title>
                                ...
                                <div class="col-lg-4 col-md-5 d-flex align-items-stretch">
                                    <div class="info-wrap bg-primary w-100 p-md-5 p-4">
                                        ...
                                        <div class="dbox w-100 d-flex align-items-center">
                                            ...
                                            <div class="text pl-3">
                                                <p><span>Email:</span> <a href="mailto:info@yoursite.com">contact@schuleinstitute.com</a></p>
                                            </div>
                                        </div>
                                        <div class="dbox w-100 d-flex align-items-center">
                                            <div class="icon d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="text pl-3">
                                                <p><span>Website</span> <a href="#">www.schuleinstitute.com</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
